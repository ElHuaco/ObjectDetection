...
#   i) Las predicciones traducidas a coord-space desde su escala, se matchean con Jaccard a cada ground truth
#   ii) Para las que tengan jaccard > 0.5, se calcula L1 de Offset y Softmax de Categorías
